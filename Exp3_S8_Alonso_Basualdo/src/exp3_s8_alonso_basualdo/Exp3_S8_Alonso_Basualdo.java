...
public class Exp3_S8_Alonso_Basualdo {
    ...
    static String[] PLATEA = new String[10]; // P1-P10 
    static String[] GENERAL = new String[15]; // G1-G15
    ...
    static void venderEntrada(){
        System.out.println("Ingrese su nombre a registrar para la compra: ");  // Analizar como se procesan las ventas
        String nombre = scanner.nextLine().trim();
        if (!validarTexto(nombre)){
            System.out.println("Nombre invalido");
            return;
        }
        System.out.println("Tipo Entrada:  Estudiante -> (E),  Adulto Mayor -> (T)  General -> (G)?:  ");
        ...
        Cliente clie = new Cliente(contadorClientes, nombre, tipo); // crea un objeto usando el constructor y lo inicializa con ID, nombre y tipo y lo guarda en la siguiente linea
        ...
        double descuento = obtenerDescuento(tipo);   // Aqui para verificar que los descuentos se aplican
    ...
    static void reservarEntrada(){
        System.out.println("Ingrese su nombre para la reserva: "); //Analiza como se maneja una reserva 
        String nombre = scanner.nextLine().trim().toUpperCase();
        if (!validarTexto(nombre)){
            System.out.println("Nombre invalido");
            return;
        }
        System.out.println("Tipo cliente -> Estudiante (E), Adulto Mayor (T) o General (G)?:  ");
        String tipo = scanner.nextLine().trim().toUpperCase();
        if(!tipo.matches("[ETG]")) { // si se ingresa una letra que no hace match con ETG no existe
            System.out.println("Tipo invalido o no existente");
            return;
        ...
        int sec = seleccionSeccion();
        if (sec < 1 || sec > 3){  // validacion para cliente al ingresar un numero inferior a 1 o mayor a 3 
            return;
        }
        mostrarAsientosDisponibles(sec);
    ...
    static void modificarReserva(){
        ...
        do {
            ...
            if (respuesta.equals("S")){
                ...
                System.out.println("Opcion no valida, favor intente nuevamente Ingrese 'S' para confirmar o 'N' para cancelar)");
            }
        }while(true);
